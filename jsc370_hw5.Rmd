...
First, we take a look at each team's field goal success rate by the starting yard line. From the visual below, we can see that the team with the furthest successful kick attempt in the 2018-2020 seasons is DAL (Dallas Cowboys)- with a kick starting at between the 45-50 yard line. Additionally, while most teams that attempt close field goal kicks (between the 0 to 5 yard line) have scored 100% of their attempts, the Miami Dolphins (MIA) and Philadelphia Eagles (PHI), looks to be significantly less successful. 
...
data %>% plot_ly(
  ...
  layout(title="Kick Length of Successful and Unsuccessful Field Goal Attempts \n per Team for 2018-2020",
         ...
         legend=list(title=list(text='Successful Kick')),
         hovermode="compare")
```
